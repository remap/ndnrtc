...
TEST(TestVideoCoderParams, TestOutput)
{
	...
	EXPECT_EQ("30FPS; GOP: 30; Start bitrate: 1000 Kbit/s; "
		"Max bitrate: 3000 Kbit/s; 1920x1080; Drop: YES", ss.str());
}
...
TEST(TestVideoCoderParams, TestOutput2)
{
	...
	EXPECT_EQ("0FPS; GOP: 0; Start bitrate: 0 Kbit/s; "
		"Max bitrate: 0 Kbit/s; 0x0; Drop: NO", ss.str());
}
...
TEST(TestVideoCoderParams, TestOutput3)
{
	...
	EXPECT_EQ("30FPS; GOP: 30; Start bitrate: 1000 Kbit/s; "
		"Max bitrate: 3000 Kbit/s; 1920x1080; Drop: NO", ss.str());
}
...
TEST(TestVideoThreadParams, TestOutput)
{
	...
	EXPECT_EQ("name: ; 0FPS; GOP: 0; Start bitrate: 0 Kbit/s; "
		"Max bitrate: 0 Kbit/s; 0x0; Drop: NO", ss.str());
...
TEST(TestVideoThreadParams, TestOutput2)
{
	...
	EXPECT_EQ("name: ; 30FPS; GOP: 30; Start bitrate: 1000 Kbit/s; "
		"Max bitrate: 3000 Kbit/s; 1920x1080; Drop: YES", ss.str());
}
...
TEST(TestVideoThreadParams, TestCopy)
{
	...
	ss << *vtpCopy;
	EXPECT_EQ("name: thread-original; 30FPS; GOP: 30; Start bitrate: 1000 Kbit/s; "
		"Max bitrate: 3000 Kbit/s; 1920x1080; Drop: YES", ss.str());
...
TEST(TestGeneralProducerParams, TestOutput)
{
	...
	ss << gpp;
	EXPECT_EQ("seg size: 0 bytes; freshness: 0 ms", ss.str());
}
...
TEST(TestGeneralProducerParams, TestOutput2)
{
	...
	gpp.freshnessMs_ = 2000;

	ss << gpp;
	EXPECT_EQ("seg size: 1000 bytes; freshness: 2000 ms", ss.str());
}
